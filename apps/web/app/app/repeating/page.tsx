    ...
    <section className="py-8">
      ...
      {recurring.length === 0 ? (
        ...
        <>
            ...
            {recurring.map((r) => (
              ...
              >
                ...
                <div className="text-sm sm:text-right">
                  <div className="font-semibold tabular-nums">{formatZAR(r.monthly)} / month</div>
                  <div className="text-muted-foreground tabular-nums">
                    {formatZAR(r.annual)} a year, if nothing changes
                  </div>
                </div>
              </Card>
            ))}
          ...
          <Card className="mt-4 border-transparent bg-accent p-4 text-sm text-accent-foreground">
